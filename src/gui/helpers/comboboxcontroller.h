 ...
 * QComboBox Updater
 *
 * Manage the items displayed in a QComboBox from a reference container, preserving the widget as much as possible on item addition
 * or deletion.
 * The lambda function should return the text to display for the item it is passed. Pointers to the items are stored as data in the
 * QComboBox to allow tests of equivalence.
 */

// Note: Nasty List<T>-based version - to be replaced with STL equivalent at some stage
